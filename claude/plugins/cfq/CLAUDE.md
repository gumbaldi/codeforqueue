...
live under `scripts/` — twenty-two of them (`cfq_settings.py`, `cfq_changelog.py`, `cfq_report.py`,
...
ported as batch `017` phase 09; `cfq_resume.py`, `cfq_finish.py` ported as batch `017` phase 10) are
